              ...
              >
                ...
                <ul className="text-gray-500 space-y-3 grow">
                  <li className="flex items-center">
                    ...
                    <span>2 AI generated images</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0"
                    ...
                    <span>Sharing with community</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0"
                    ...
                    <span>2 high resolution image downloads </span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0"
              ...
              >
                ...
                <ul className="text-gray-400 space-y-3 grow">
                  <li className="flex items-center">
                    ...
                    <span>Unlimited high resolution downloads</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0"
                    ...
                    <span>Get access to our print on demand service</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0"
                    ...
                    <span>50 AI generated images</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0"
                    ...
                    <span>Access to the community channel</span>
                  </li>
                </ul>
              </div>
            </div>
