...
function FreeTrial() {
  return (
    <div className="relative ">
      ...
      {/* Content */}
      <div className="md:flex max-w-lg mx-auto space-y-8 pt-32 md:space-y-0 px-4 sm:px-6 pb-16 md:pb-20 drop-shadow-lg">
        <div className="h-full">
          <div className="mb-10">
            <h1 className="h2 text-center font-cabinet-grotesk">
              Join the community of creatives
            </h1>
          </div>

          <div className="text-xl font-cabinet-grotesk font-bold text-gray-900 mb-4">
            Let's get started.
          </div>
          ...
          >
            ...
            <div className="flex items-center justify-between space-x-2 mt-6">
              <button className="px-4 py-2 rounded-full text-sm w-full inline-flex justify-center items-center text-white bg-gray-900 hover:bg-gray-800 group">
                Join The Community
